...
# 下载轻量级模型（手机推荐）
ollama pull qwen2:0.5b  # 0.5B参数，仅需2GB内存
# 或
ollama pull gemma:2b     # 2B参数，需3GB内存
```
...
在手机上运行 AI 陪伴系统，无需依赖云端！

**方法1：使用 Termux（Android）**

```bash
# 1. 安装 Termux
# 从 F-Droid 下载安装 Termux
...
然后在手机浏览器中访问 `http://localhost:7860`
...
| Phi-2 | 2.7B | 4GB | 高端手机 |
| Mistral-7B-Q4 | 7B (4-bit) | 5GB | 手机/平板 |
| Qwen2-7B | 7B | 8GB | 平板/电脑 |
